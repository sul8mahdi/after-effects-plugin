...
BUNDLE_ID="com.sul8mahdi.iconmpro"
...
# SAFETY: this installer manages ONLY its own folder ($LINK_PATH). It never
# deletes or touches any other extension — your other tools stay untouched.
